...
# SECRET_KEY = 'django-insecure-huza+7tl9f^h69j+v*9irkt70-4ovz)k9(*%(5^!_v#z$6tcs@'
...
# STATIC_ROOT = os.path.join(BASE_DIR, 'static')  # Change this to your desired directory for collected static files
